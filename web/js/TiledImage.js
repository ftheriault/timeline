...
TiledImage.prototype.setContinuous = function (continuous) {
		...
		if (this.horizontal) {
			if (this.imageCurrentCol + 1 >= this.imageAnimationMax) {
				...
				if (this.continuous) {
					...
					if (this.imageCurrentRow >= this.imageTileRowCount) {
						if (this.looped) this.imageCurrentRow = 0;
						else this.imageCurrentRow--;
					}
				}
			}
			else {
			...
			if (this.imageCurrentRow + 1 >= this.imageAnimationMax) {
				...
				if (this.continuous) {
					...
					if (this.imageCurrentCol >= this.imageTileColCount) {
						if (this.looped) this.imageCurrentCol = 0;
						else this.imageCurrentCol--;
					}
				}
			}
			else {
